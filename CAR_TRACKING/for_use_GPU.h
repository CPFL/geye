...
//extern double ***fconvsMT_GPU(CUdeviceptr featp2_dev, double **filter,int *sym_info,int start,int end,int **A_SIZE, CUdeviceptr A_SIZE_dev, int **B_SIZE,int **M_size_array, int L_MAX, int interval, int *FSIZE, int padx, int pady, int max_X, int max_Y, int calc_flag);
extern double ***fconvsMT_GPU(CUdeviceptr featp2_dev, double **filter,int *sym_info,int start,int end,int *A_SIZE, CUdeviceptr A_SIZE_dev, int **B_SIZE,int **M_size_array, int L_MAX, int interval, int *FSIZE, int padx, int pady, int max_X, int max_Y, int calc_flag);
